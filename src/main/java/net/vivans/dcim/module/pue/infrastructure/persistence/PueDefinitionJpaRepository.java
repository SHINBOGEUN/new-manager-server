...
public class PueDefinitionJpaRepository implements PueDefinitionRepository {
 ...
 public List<PueDefinition> findAll(){return repository.findAll();}
 public List<PueDefinition> findAllByDeviceGroupId(Integer id){return repository.findDistinctByDeviceGroupsDeviceGroupId(id);}
 public boolean existsByDeviceGroupId(Integer id){return repository.existsByDeviceGroupsDeviceGroupId(id);}
